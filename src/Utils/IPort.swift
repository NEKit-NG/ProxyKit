...
public struct IPort: CustomStringConvertible, ExpressibleByIntegerLiteral {
    ...
    public init(integerLiteral value: IPort.IntegerLiteralType) {
...
public func == (left: IPort, right: IPort) -> Bool {
    return left.valueInNetworkOrder == right.valueInNetworkOrder
}

extension IPort: Hashable {}
